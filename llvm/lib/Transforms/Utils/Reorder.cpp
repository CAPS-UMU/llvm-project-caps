                ...
                if (currentInst == startInst) {
                    ...
                    for (auto it = Int_ins.rbegin(); it != Int_ins.rend(); ++it){
                      ...
                      if (isa<StoreInst>(*it)){//&& (DA.depends(*it, startInst, true))){ 
                        ...
                        if( (AA.alias(loadInst, int_mem_op) == AliasResult:: MustAlias) && (AA.alias(prevLoadInst, int_mem_op) == AliasResult:: MustAlias)){//(DA.depends(prevLoad, int_mem_op, true))){ //){
                            Int_ins.clear();
                            wasted++;
                            ...
                            break;
                        } else if((AA.alias(loadInst, int_mem_op) == AliasResult:: MustAlias) && (AA.alias(prevLoadInst, int_mem_op) != AliasResult:: MustAlias)){
                        ...
                        if((AA.alias(loadInst, int_mem_op) == AliasResult:: MayAlias)){
